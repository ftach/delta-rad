...
results_dict = json.load(open('json_results/result_random_run.json'))
...
delta_rad_tables = ['f1_gtv.csv', 'f5_gtv.csv', 'rd_f1_f5_gtv.csv', 'rd_f1_f3_gtv.csv', 'rd_f1_f4_gtv.csv']
...
results = pd.read_json('json_results/result_random_run.json') 
