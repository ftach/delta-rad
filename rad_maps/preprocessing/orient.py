...
# we orient them in the right direction and save them in /home/tachennf/Documents/delta-rad/data/ICM_0.35T/oriented_data/
...
def main(original_data_path: str, oriented_data_path: str): 
    patient_list = [p for p in os.listdir(original_data_path)]
    for p in patient_list:
        # create patient folder 
        if os.path.exists(oriented_data_path + p) == False:
            os.makedirs(oriented_data_path + p)
        # images 
        if os.path.exists(oriented_data_path + p + '/img_dir/') == False:
            os.makedirs(oriented_data_path + p + '/img_dir/')
        ...
        for i in img_files:
            ...
            orient_img_path = oriented_data_path + p + '/img_dir/' + i
            sitk.WriteImage(oriented_img, orient_img_path)
        # mask 
        if os.path.exists(oriented_data_path + p + '/mask_dir/') == False:
            os.makedirs(oriented_data_path + p + '/mask_dir/')
        ...
        for m in mask_files:
            ...
            orient_mask_path = oriented_data_path + p + '/mask_dir/' + m
...
if __name__ == '__main__':
    ...
    oriented_data_path = '/home/tachennf/Documents/delta-rad/data/ICM_0.35T/oriented_data/'
    main(original_data_path, oriented_data_path)
