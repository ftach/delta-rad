...
def main(): 
    ...
    patients_filtered = ['Patient76']

    # enabled_features = ['original_firstorder_Entropy', 'original_gldm_DependenceEntropy', 'original_glrlm_GrayLevelNonUniformity']
    enabled_features = None # ['original_firstorder_Kurtosis', 'original_gldm_DependenceEntropy'] # 'original_glcm_Imc1', # TODO/ deal size issue witg glcm_Imc1 features

    # COMPUTE SIMPLE FEATURE MAPS AND ANALYZE THEIR PARAMETERS 
    enabled_features = gm.compute_feature_maps(fractions, patients_filtered, params, enabled_features, 'ptv') 
