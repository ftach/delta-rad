...
# COMPUTE DELTA FEATURES MAPS 
    enabled_features = gm.compute_feature_maps(fractions, patients_filtered, params, enabled_features, mask_type) # optional if already computed 
    gm.compute_delta_maps(fractions, patients_filtered, enabled_features, mask_type) # optional if already computed
